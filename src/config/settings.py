"""
Configurações do projeto NFe Scraper
"""
import os
...
# Alias para compatibilidade
TIMEOUT_SEGUNDOS = PAGE_LOAD_TIMEOUT
...
# Separador CSV (padrão brasileiro)
CSV_SEPARATOR = ';'

# Decimal CSV (padrão brasileiro)
CSV_DECIMAL = ','
